const CACHE='alltag-v2.2.0';
const SHELL=['/','/index.html','/manifest.webmanifest','/icon.svg','/app.css','/v11.css','/gold-goldde.css','/optimizer-v13.css','/v2.css','/bank-available-v21.css','/remove-remember-v22.css','/app-base.js','/app-pages.js','/app-sheets.js','/app-main.js','/gold-goldde.js','/bank-v2.js','/optimizer-v13.js','/ux-v2.js','/bank-available-v21.js','/remove-remember-v22.js'];
